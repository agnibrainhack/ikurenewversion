...
public class Diabetes_Graph_Random extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("Random Trends");
        ...
        LimitLine upper_limit = new LimitLine(125f, "Upper Limit");
        upper_limit.setLineWidth(4f);
        upper_limit.enableDashedLine(10f, 10f, 0f);
        upper_limit.setLabelPosition(LimitLine.LimitLabelPosition.RIGHT_TOP);
        upper_limit.setTextSize(10f);

        LimitLine lower_limit = new LimitLine(50f, "Lower Limit");
        ...
        leftAxis.setAxisMaxValue(greatest + 15);
    ...
    private void setData() {
        ...
        set1 = new LineDataSet(yVals, "Random Levels");
